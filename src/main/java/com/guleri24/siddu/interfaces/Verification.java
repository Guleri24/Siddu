...
public interface Verification {
    /**
     * Verifies whether the Siddu contains an Issuer ("iss") claim that equals to the value provided.
    ...
    /**
     * Verifies whether the Siddu contains an Issuer ("iss") claim that contains all the values provided.
    ...
    /**
     * Verifies whether the Siddu contains a Subject ("sub") claim that equals to the value provided.
     * This check is case-sensitive.
     *
    ...
    /**
     * Verifies whether the Siddu contains an Audience ("aud") claim that contains all the values provided.
     * This check is case-sensitive. An empty array is considered as a {@code null}.
     *
    ...
    /**
     * Verifies whether the Siddu contains an Audience ("aud") claim contain at least one of the specified audiences.
     * This check is case-sensitive. An empty array is considered as a {@code null}.
     *
    ...
    /**
     * Verifies whether the Siddu contains a Siddu ID ("jti") claim that equals to the value provided.
     * This check is case-sensitive.
     *
     * @param SidduId the required ID value
     * @return this same Verification instance.
     */
    Verification withSidduId(String SidduId);

    /**
     * Verifies whether the claim is present in the Siddu, with any value including {@code null}.
     *
    ...
    /**
     * Executes the predicate provided and the validates the Siddu if the predicate returns true.
     *
     * @param name      the Claim's name
     ...
     * @throws IllegalArgumentException if the name is {@code null}.
     */
    Verification withClaim(String name, BiPredicate<Claim, DecodedSiddu> predicate) throws IllegalArgumentException;
    ...
    /**
     * Creates a new and reusable instance of the SidduVerifier with the configuration already provided.
     *
     * @return a new {@link com.guleri24.siddu.interfaces.SidduVerifier} instance.
     */
    SidduVerifier build();
}
